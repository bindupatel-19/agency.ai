...
const Navbar = ({ theme, setTheme }) => {
  ...
  return (
    <div className=" flex justify-between items-center px-4 sm:px-12 lg:px-24 xl:px-40 py-4 sticky top-0 z-20 backdrop-blur-xl font-medium bg-white">
      <img
      ...
      <div
        className={`text-gray-700 dark:text-black sm:text-sm ${
          !sidebarOpen
            ? "max-sm:w-0 overflow-hidden"
            : "max-sm:w-60max-sm:pl-10"
        } 
